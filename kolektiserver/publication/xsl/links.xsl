...
<xsl:stylesheet
  ...
  <xsl:template match="html:a[@href]">
    ...
    <xsl:variable name="lhref">
      <xsl:call-template name="substlang">
  ...
  <xsl:template name="substlang">
    <xsl:param name="href"/>

    <xsl:choose>
      <xsl:when test="contains($href,'_LANG_')">

        <xsl:value-of select="substring-before($href,'_LANG_')"/>
        <xsl:value-of select="$lang"/>
        <xsl:call-template name="substlang">
          <xsl:with-param name="href" select="substring-after($href,'_LANG_')"/>
        </xsl:call-template>
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="$href"/>
