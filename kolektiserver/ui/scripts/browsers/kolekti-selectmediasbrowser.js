function selectmediasbrowser(id) {
    this.id=id;
    this.tabs=new Array();
...
selectmediasbrowser.prototype=new kolekti_browser;

selectmediasbrowser.prototype.initevent = function() {
    var me=this;
...
selectmediasbrowser.prototype.preview = function(arg) {
...
selectmediasbrowser.prototype.select = function() {
